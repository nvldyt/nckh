...
import key_manager  # Gọi trái tim chứa Key ở đây
...
# ============================================================
# 4. TẠO TỪ KHÓA MESH VỚI GEMINI (Đồng bộ Key Offline)
# ============================================================
...
"""
        ...
        for attempt in range(2):
            try:
                # Gọi Key từ module quản lý
                api_key = key_manager.get_next_key()
                if not api_key or api_key == "CHUA_CO_KEY":
                    return query 

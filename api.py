...
async def translate_to_mesh(request: MeshRequest):
    ...
    system_prompt = (
        ...
        "- TUYỆT ĐỐI KHÔNG giải thích, KHÔNG thêm câu chào.\n\n"
        "--- TỪ ĐIỂN ÁNH XẠ MESH BẮT BUỘC ---\n"
        "- Thuốc, dược phẩm (Medicine, Medication, Prescription): \"Pharmaceutical Preparations\"[Mesh] OR \"Drug Therapy\"[Mesh] OR \"Drug Utilization\"[Mesh]\n"
        "- Kháng sinh (Antibiotics): \"Anti-Bacterial Agents\"[Mesh]\n"
        "- Bệnh đái đường / đái tháo đường (Diabetes): \"Diabetes Mellitus\"[Mesh]\n"
        "- Bệnh đau dạ dày (Stomach ache): \"Stomach Diseases\"[Mesh] OR \"Gastritis\"[Mesh]\n"
        "- Bệnh đau tim (Heart-disease): \"Heart Diseases\"[Mesh]\n"
        "- Bệnh viêm gan (Hepatitis): \"Hepatitis\"[Mesh]\n"
        "- Bệnh sốt rét (Malaria): \"Malaria\"[Mesh]\n"
        "- Bệnh sốt xuất huyết (Dengue fever): \"Dengue\"[Mesh]\n"
        "- Bệnh lao (Tuberculosis): \"Tuberculosis\"[Mesh]\n"
        "- Ung thư (Cancer): \"Neoplasms\"[Mesh]\n"
        "- Ngộ độc (Poisoning): \"Poisoning\"[Mesh]\n"
        "- Dị ứng (Allergy): \"Hypersensitivity\"[Mesh]\n"
        "(Ghi chú: Mô hình tự động áp dụng các từ khóa trên nếu xuất hiện trong đề tài)\n"
        "------------------------------------\n\n"
